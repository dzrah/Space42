<script lang="ts">
	...
	function fixFormWidth() {
		const wrapper = document.querySelector('.sc-dynamics-form-wrapper');
		if (!wrapper) return;
		...
		<div class="flex flex-col md:flex-row gap-8 lg:gap-12 py-16 lg:py-24 items-start">
			...
			<div class="w-full md:w-[35%] shrink-0">
				...
				<p class="font-antarctica font-light text-gray-600 text-sm leading-relaxed mb-6">
					Tell us about your environment and requirements. We'll help you maintain secure, reliable
					communications beyond terrestrial networks.
				</p>
				<p class="font-antarctica font-light text-gray-500 text-xs">* Mandatory Field</p>
			</div>
			<!-- Right: Dynamics form -->
			<div class="w-full md:w-[65%] min-w-0">
				<div class="sc-dynamics-form-wrapper">
					<div
						data-form-id="90872a81-9a2d-f111-8341-7ced8d579011"
						data-form-api-url="https://public-uae.mkt.dynamics.com/api/v1.0/orgs/b0843b43-2e40-ee11-94d3-6045bd6a6257/landingpageforms"
						data-cached-form-url="https://assets-uae.mkt.dynamics.com/b0843b43-2e40-ee11-94d3-6045bd6a6257/digitalassets/forms/90872a81-9a2d-f111-8341-7ced8d579011"
					></div>
				</div>
			</div>
		</div>
