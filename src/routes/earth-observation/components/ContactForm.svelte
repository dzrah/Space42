<script lang="ts">
	...
	function fixFormWidth() {
		const wrapper = document.querySelector('.eo-dynamics-form-wrapper');
		if (!wrapper) return;
	...
	<Container>
		<div class="flex flex-col md:flex-row gap-8 lg:gap-12 py-16 lg:py-24 items-start">
			...
			<div class="w-full md:w-[65%] min-w-0">
				<div class="eo-dynamics-form-wrapper">
					<!-- TODO: Replace with Earth Observation form ID -->
					<div
						data-form-id="1e857673-992d-f111-8341-7ced8d579011"
						data-form-api-url="https://public-uae.mkt.dynamics.com/api/v1.0/orgs/b0843b43-2e40-ee11-94d3-6045bd6a6257/landingpageforms"
						data-cached-form-url="https://assets-uae.mkt.dynamics.com/b0843b43-2e40-ee11-94d3-6045bd6a6257/digitalassets/forms/1e857673-992d-f111-8341-7ced8d579011"
					></div>
				</div>
			</div>
		</div>
